...
Examples:
  ...
  bash tools/local_ci.sh --build-dir build_vcpkg --strict-exit
USAGE
}
...
main() {
  ...
  cmake -S . -B "$BUILD_DIR" -DCMAKE_BUILD_TYPE="$BUILD_TYPE" -DBUILD_EDITOR_QT=OFF -DCADGF_USE_NLOHMANN_JSON=ON -DCADGF_SORT_RINGS=ON $GEN
