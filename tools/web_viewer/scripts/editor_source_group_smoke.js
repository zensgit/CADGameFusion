...
function usage() {
  return [
    'Usage: node tools/web_viewer/scripts/editor_source_group_smoke.js [--fixture /tools/web_viewer/tests/fixtures/editor_source_group_fixture.json] [--outdir <dir>] [--base-url http://127.0.0.1:8080/] [--url-prefix deps/cadgamefusion]',
    '',
