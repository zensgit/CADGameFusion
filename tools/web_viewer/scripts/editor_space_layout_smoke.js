...
function usage() {
  return [
    'Usage: node tools/web_viewer/scripts/editor_space_layout_smoke.js [--fixture /tools/web_viewer/tests/fixtures/editor_space_layout_fixture.json] [--outdir <dir>] [--base-url http://127.0.0.1:8080/] [--url-prefix deps/cadgamefusion]',
    '',
...
async function run() {
  ...
  try {
    ...
    const url = new URL(prefixRelativePath('tools/web_viewer/index.html', args.urlPrefix), resolvedBase);
