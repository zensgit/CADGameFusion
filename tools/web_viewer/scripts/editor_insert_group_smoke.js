...
function usage() {
  return [
    'Usage: node tools/web_viewer/scripts/editor_insert_group_smoke.js [--fixture /tools/web_viewer/tests/fixtures/editor_insert_group_fixture.json] [--outdir <dir>] [--base-url http://127.0.0.1:8080/] [--url-prefix deps/cadgamefusion]',
    '',
...
async function run() {
  ...
  try {
    ...
    const pageUrl = new URL(prefixRelativePath('tools/web_viewer/index.html', args.urlPrefix), baseUrl);
