...
} from '../ui/property_panel_entity_fields.js';
...
test('buildInsertProxyTextFieldDescriptors preserves ATTDEF label and optional position fields', () => {
...
test('buildSingleEntityEditFieldDescriptors forwards update messages', () => {
  const calls = [];
