...
int main() {
    ...
    {
        std::vector<Polyline> A{{0,EntityType::Polyline,"A",nullptr}}; A[0].points = rect(0,0,10,10);
        std::vector<Polyline> B{{0,EntityType::Polyline,"B",nullptr}}; B[0].points = rect(5,5,15,15);
