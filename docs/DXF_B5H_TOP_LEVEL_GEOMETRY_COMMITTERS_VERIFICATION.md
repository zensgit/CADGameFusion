# DXF B5h: Top-Level Geometry Committers Verification

Run from:

- `/Users/huazhou/Downloads/Github/VemCAD/.worktrees/dxf-b5h-top-level-geometry-committers-cadgf`
...
- no new failures versus post-B5g baseline
...
- only the simple geometry loops moved
- text and dimension text remain in `dxf_top_level_entity_committers.cpp`
- geometry omission rules and metadata writes are unchanged
