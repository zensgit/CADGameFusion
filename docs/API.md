...
Endpoints
- `GET /health` → `{status:"ok", version:"1.0.0", commit:"abc1234", build_time:"2024-01-01T00:00:00Z", hostname:"router-01", pid:12345, uptime_seconds:120, plugin_map:[...], default_plugin:"...", default_convert_cli:"...", error_codes:[...]}`
