# Step 74: Document Schema Validation CLI - Verification

## Checks
```bash
PYTHONPYCACHEPREFIX=/tmp/pycache python3 -m py_compile tools/plm_convert.py tools/plm_router_service.py
```
...
path = Path("/tmp/plm_validate_test/document.json")
