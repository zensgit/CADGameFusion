...
set(_cases "${outdir}/editor_assembly_roundtrip_paperspace_cases.json")
file(WRITE "${_cases}" "[\n")
file(APPEND "${_cases}" "  {\n")
file(APPEND "${_cases}" "    \"name\": \"assembly_paperspace_insert_leader\",\n")
file(APPEND "${_cases}" "    \"path\": \"${_inputdoc}\",\n")
file(APPEND "${_cases}" "    \"tags\": [\"assembly-roundtrip\", \"paperspace\"],\n")
...
foreach(_needle
  ...
  if(_idx EQUAL -1)
    message(FATAL_ERROR "${_needle} not found in paperspace editor assembly roundtrip summary:\n${_summary_text}")
  endif()
endforeach()
...
foreach(_needle
  ...
  if(_idx EQUAL -1)
    message(FATAL_ERROR "${_needle} not found in paperspace source document:\n${_input_text}")
  endif()
endforeach()

message(STATUS "paperspace editor assembly roundtrip semantics validated")
